...
/* Definitions for PTP_Task */
osThreadId_t PTP_TaskHandle;
const osThreadAttr_t PTP_Task_attributes = {
  .name = "PTP_Task",
  .stack_size = 1024 * 4,
...
void StartPTPTask(void *argument);
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of PTP_Task */
  PTP_TaskHandle = osThreadNew(StartPTPTask, NULL, &PTP_Task_attributes);
...
/* USER CODE BEGIN Header_StartPTPTask */
/**
  * @brief  Function implementing the PTP_Tsak thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartPTPTask */
void StartPTPTask(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
